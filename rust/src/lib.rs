...
#[no_mangle]
pub unsafe extern "C" fn Java_com_ppaass_agent_rust_jni_RustLibrary_stopVpn(
    _jni_env: JNIEnv,
    _class: JClass,
) {
    JAVA_VPN_JVM.take();
...
pub unsafe extern "C" fn Java_com_ppaass_agent_rust_jni_RustLibrary_startVpn(
    ...
    let ppaass_vpn_server =
        PpaassVpnServer::new(vpn_tun_device_fd).expect("Fail to generate ppaass vpn server.");
