...
import com.ppaass.agent.rust.protocol.message.PpaassMessageAgentPayload;
import com.ppaass.agent.rust.protocol.message.PpaassMessageAgentPayloadType;
...
import com.ppaass.agent.rust.protocol.message.payload.*;
