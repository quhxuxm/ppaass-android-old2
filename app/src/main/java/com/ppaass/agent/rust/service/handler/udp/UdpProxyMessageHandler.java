...
import com.ppaass.agent.rust.protocol.message.PpaassMessageProxyPayload;
import com.ppaass.agent.rust.protocol.message.PpaassMessageProxyPayloadType;
import com.ppaass.agent.rust.protocol.message.address.PpaassNetAddress;
import com.ppaass.agent.rust.protocol.message.payload.DomainResolveResponseType;
